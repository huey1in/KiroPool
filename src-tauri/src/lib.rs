...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(generate_handler![
            ...
            api::del_user_data,
            // Kiro
            kiro::commands::get_kiro_status,
            kiro::commands::get_kiro_usage,
            kiro::commands::switch_kiro_account,
            kiro::commands::list_owned_kiro_accounts,
            kiro::commands::delete_owned_kiro_account,
            kiro::commands::switch_owned_kiro_account,
            kiro::commands::close_kiro,
            kiro::commands::launch_kiro,
            kiro::commands::set_kiro_path,
            kiro::commands::get_machine_id,
            kiro::commands::restore_original_machine_id,
            commands::system::check_admin_privileges,
            // 线路管理
            commands::system::refresh_inbound,
            // 日志
            commands::system::log_error,
            commands::system::log_warn,
            commands::system::log_info,
            // devtools
