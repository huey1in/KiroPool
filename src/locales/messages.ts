export const messages = {
  'zh-CN': {
    ...
    dashboard: {
      ...
      cancelSwitch: '取消',
      ccStatus: '本地Curso状态',
      registerTime: '本地Kiro账户注册时间',
      insufficientCredits: '剩余额度不足, 请先充值',
      email: '本地Kiro邮箱',
      cpUsage: 'Kiro Pool额度使用量',
      advancedModelUsage: '高级模型使用量',
      basicModelUsage: '普通模型使用量',
      cannotGetUsage: '无法链接kiro服务器, 请重启软件',
      kiroHistoryDownload: 'Kiro 历史版本下载',
      kiroDbError: 'Kiro未安装或从未启动过',
      kiroNetworkError: '网络连接错误, 无法链接kiro服务器',
      kiroDataError: 'Kiro服务器返回数据格式异常',
      kiroUnknownError: 'Kiro未知错误, 请重启软件',
      kiroProUnlimitedTip: 'Kiro最新政策改为Pro以及Pro试用用户可以无限制调用模型',
    },
    login: {
      title: '登录',
    ...
    systemControl: {
      title: '系统控制',
      credentialStatus: '客户端注入状态',
      credentialApplied: '已注入客户端',
      credentialNotApplied: '未注入或客户端不支持',
      applyCredential: '注入客户端',
      restoreCredential: '还原客户端',
      clientStatus: '客户端状态',
      clientVerified: '已验证',
      ...
      messages: {
        applyCredentialSuccess: '注入客户端成功',
        restoreCredentialSuccess: '恢复客户端成功',
        kiroRunning: 'Kiro进程正在运行, 请先关闭Kiro',
    ...
    common: {
      ...
      kiroRunning: 'Kiro 正在运行',
      kiroRunningMessage:
        '检测到 Kiro 正在运行, 请保存尚未更改的项目再继续操作! 不保存会导致Kiro报错! 报错了请别联系客服!',
      closingKiro: '正在关闭 Kiro...',
      forgotPassword: '忘记密码？',
      unknown: '未知',
      notBound: '本地Kiro没有登录账户',
      verified: '已验证',
      unverified: '未验证',
      success: '成功',
      failed: '失败',
    ...
    historyAccount: {
      ...
      deleteSuccess: '删除成功',
      deleteFailed: '删除失败',
      credentialFailed: '注入失败，请手动注入后再试',
  ...
  'en-US': {
    ...
    dashboard: {
      ...
      kiroHistoryDownload: 'Kiro History Versions Download',
      kiroDbError: 'Kiro database does not exist or data not found',
      kiroNetworkError: 'Network connection error, please check your network',
      kiroDataError: 'Kiro returned data format abnormal',
      kiroUnknownError: 'Kiro unknown error, please restart the software',
      kiroProUnlimitedTip:
        'Kiro latest policy changed to Pro and Pro trial users can call models unlimited',
    },
    login: {
      title: 'Login',
    ...
    systemControl: {
      ...
      credentialApplied: 'Applied',
      credentialNotApplied: 'Not Applied',
      applyCredential: 'Apply Credential',
      restoreCredential: 'Restore Credential',
      ...
      messages: {
        ...
        applyCredentialSuccess: 'Credential applied successfully',
        restoreCredentialSuccess: 'Credential restored successfully',
        kiroRunning: 'Kiro is running, please save your work before continuing!',
      ...
      history: {
        ...
        applyCredential: 'Aplicar credential',
        restoreCredential: 'Restaurar credential',
      },
    },
    about: {
      title: 'About',
    ...
    common: {
      ...
      kiroRunning: 'Kiro is running',
      kiroRunningMessage:
        'Kiro läuft, bitte speichern Sie das Projekt, das noch nicht geändert wurde, bevor Sie fortfahren!',
      closingKiro: 'Closing Kiro...',
      forgotPassword: 'Forgot password?',
      unknown: 'Unknown',
      notBound: 'Not Bound',
      verified: 'Verified',
    ...
    historyAccount: {
      ...
      credentialFailed: 'Injection failed, please try manually injecting',
  ...
  'ja-JP': {
    ...
    dashboard: {
      ...
      kiroHistoryDownload: 'Kiro 履歴バージョン ダウンロード',
      kiroDbError: 'Kiroデータベースが存在しないかデータが見つかりません',
      kiroNetworkError: 'ネットワーク接続エラー、ネットワークを確認してください',
      kiroDataError: 'Kiroから返されたデータ形式が異常です',
      kiroUnknownError: 'Kiro未知のエラー、ソフトウェアを再起動してください',
      kiroProUnlimitedTip:
        'Kiro latest policy changed to Pro and Pro trial users can call models unlimited',
    },
    login: {
    ...
    systemControl: {
      title: 'システム制御',
      credentialStatus: 'フック状態',
      credentialApplied: '適用済み',
      credentialNotApplied: '未適用',
      applyCredential: 'フックを適用',
      restoreCredential: 'フックを復元',
      updateStatus: '自動更新状態',
      updateDisabled: '無効',
      updateEnabled: '有効',
      ...
      messages: {
        ...
        applyCredentialSuccess: 'フックを適用しました',
        restoreCredentialSuccess: 'フックを復元しました',
        kiroRunning: 'Kiroが実行中です。続行する前に作業を保存してください！',
    ...
    common: {
      ...
      kiroRunning: 'Kiroが実行中です',
      kiroRunningMessage: 'Kiroが実行中です。続行する前に未保存のプロジェクトを保存してください！',
      closingKiro: 'Kiro を閉じています...',
      forgotPassword: 'パスワードを忘れた場合',
    ...
    historyAccount: {
      ...
      deleteSuccess: '削除成功',
      deleteFailed: '削除失敗',
      credentialFailed: '注入失敗、手動での注入を試してください',
  ...
  'fr-FR': {
    ...
    dashboard: {
      ...
      kiroInfo: 'Informations sur le curseur',
      kiroAccount: 'Compte du curseur',
      kiroUsage: 'Utilisation du curseur',
      ...
      kiroHistoryDownload: 'Télécharger les versions historiques de Kiro',
      kiroDbError: "La base de données Kiro n'existe pas ou les données sont introuvables",
      kiroNetworkError: 'Erreur de connexion réseau, veuillez vérifier votre réseau',
      kiroDataError: 'Format de données anormal retourné par Kiro',
      kiroUnknownError: 'Erreur inconnue de Kiro, veuillez redémarrer le logiciel',
      kiroProUnlimitedTip:
        'Kiro latest policy changed to Pro and Pro trial users can call models unlimited',
    },
    login: {
    ...
    systemControl: {
      ...
      credentialStatus: 'Statut du credential',
      credentialApplied: 'Appliqué',
      credentialNotApplied: 'Non appliqué',
      applyCredential: 'Appliquer le credential',
      restoreCredential: 'Restaurer le credential',
      ...
      messages: {
        disableUpdateSuccess: 'Auto update disabled successfully',
        restoreUpdateSuccess: 'Auto update restored successfully',
        applyCredentialSuccess: 'Credential aplicado con éxito',
        restoreCredentialSuccess: 'Credential restaurado con éxito',
        kiroRunning: 'Kiro en ejecución, por favor guarde su trabajo antes de continuar!',
    ...
    common: {
      ...
      kiroRunning: "Kiro en cours d'exécution",
      kiroRunningMessage:
        "Détecté que le Kiro est en cours d'exécution, veuillez enregistrer le projet qui n'a pas été modifié avant de continuer!",
      closingKiro: 'Fermeture du Kiro...',
      forgotPassword: 'Mot de passe oublié?',
    ...
    historyAccount: {
      ...
      credentialFailed: "Échec de l'injection, veuillez essayer manuellement",
  ...
  'de-DE': {
    ...
    dashboard: {
      ...
      kiroInfo: 'Kiro-Informationen',
      kiroAccount: 'Kiro-Konto',
      kiroUsage: 'Kiro-Nutzung',
      ...
      kiroHistoryDownload: 'Kiro Historische Versionen Herunterladen',
      kiroDbError: 'Kiro-Datenbank existiert nicht oder Daten nicht gefunden',
      kiroNetworkError: 'Netzwerkverbindungsfehler, bitte überprüfen Sie Ihr Netzwerk',
      kiroDataError: 'Kiro lieferte abnormales Datenformat zurück',
      kiroUnknownError: 'Kiro unbekannter Fehler, bitte starten Sie die Software neu',
      kiroProUnlimitedTip:
        'Kiro latest policy changed to Pro and Pro trial users can call models unlimited',
    },
    login: {
    ...
    systemControl: {
      ...
      credentialStatus: 'Credential-Status',
      credentialApplied: 'Angewendet',
      credentialNotApplied: 'Nicht angewendet',
      applyCredential: 'Credential anwenden',
      restoreCredential: 'Credential wiederherstellen',
    ...
    common: {
      ...
      kiroRunning: 'Kiro läuft',
      kiroRunningMessage:
        'Kiro läuft, bitte speichern Sie das Projekt, das noch nicht geändert wurde, bevor Sie fortfahren!',
      closingKiro: 'Kiro schließen...',
      forgotPassword: 'Mot de passe oublié?',
    ...
    historyAccount: {
      ...
      credentialFailed: 'Injektion fehlgeschlagen, bitte versuchen Sie es manuell',
  ...
  'ko-KR': {
    ...
    dashboard: {
      ...
      kiroHistoryDownload: 'Kiro 이전 버전 다운로드',
      kiroDbError: 'Kiro 데이터베이스가 존재하지 않거나 데이터를 찾을 수 없습니다',
      kiroNetworkError: '네트워크 연결 오류, 네트워크를 확인하세요',
      kiroDataError: 'Kiro가 반환한 데이터 형식이 비정상입니다',
      kiroUnknownError: 'Kiro 알 수 없는 오류, 소프트웨어를 재시작하세요',
      kiroProUnlimitedTip:
        'Kiro latest policy changed to Pro and Pro trial users can call models unlimited',
    },
    login: {
    ...
    systemControl: {
      title: '시스템 제어',
      credentialStatus: 'Credential 상태',
      credentialApplied: '적용됨',
      credentialNotApplied: '미적용',
      applyCredential: '훅 적용',
      restoreCredential: '훅 복원',
      ...
      messages: {
        ...
        applyCredentialSuccess: '훅이 적용되었습니다',
        restoreCredentialSuccess: '훅이 복원되었습니다',
        kiroRunning: 'Kiro가 실행 중입니다. 계속하기 전에 작업을 저장하세요!',
    ...
    common: {
      ...
      kiroRunning: 'Kiro 실행 중',
      kiroRunningMessage: '변경되지 않은 프로젝트를 저장한 후 계속하세요!',
      closingKiro: 'Kiro 닫는 중...',
      forgotPassword: '비밀번호를 잊으셨나요?',
    ...
    historyAccount: {
      ...
      deleteSuccess: '삭제 성공',
      deleteFailed: '삭제 실패',
      credentialFailed: '주입 실패, 수동으로 주입해 보세요',
  ...
  'ru-RU': {
    ...
    dashboard: {
      ...
      kiroInfo: 'Информация о курсоре',
      kiroAccount: 'Аккаунт курсора',
      kiroUsage: 'Использование курсора',
      ...
      kiroHistoryDownload: 'Скачать исторические версии Kiro',
      kiroDbError: 'База данных Kiro не существует или данные не найдены',
      kiroNetworkError: 'Ошибка подключения к сети, проверьте вашу сеть',
      kiroDataError: 'Kiro вернул данные в неправильном формате',
      kiroUnknownError: 'Неизвестная ошибка Kiro, перезапустите программу',
      kiroProUnlimitedTip:
        'Kiro latest policy changed to Pro and Pro trial users can call models unlimited',
    },
    login: {
    ...
    systemControl: {
      ...
      credentialStatus: 'Состояние Credential',
      credentialApplied: 'Применено',
      credentialNotApplied: 'Не применено',
      applyCredential: 'Применить Credential',
      restoreCredential: 'Восстановить Credential',
    ...
    common: {
      ...
      kiroRunning: 'Kiro в работе',
      kiroRunningMessage:
        'Обнаружен запущенный Kiro, пожалуйста, сохраните несохраненные изменения проекта, прежде чем продолжить!',
      closingKiro: 'Закрытие Kiro...',
      forgotPassword: 'Забыли пароль?',
    ...
    historyAccount: {
      ...
      credentialFailed: 'Не удалось внедрить, попробуйте сделать это вручную',
  ...
  'es-AR': {
    ...
    dashboard: {
      ...
      kiroInfo: 'Información del kiro',
      kiroAccount: 'Cuenta del kiro',
      kiroUsage: 'Uso del kiro',
      ...
      kiroHistoryDownload: 'Descargar versiones históricas de Kiro',
      kiroDbError: 'La base de datos de Kiro no existe o no se encontraron datos',
      kiroNetworkError: 'Error de conexión de red, compruebe su red',
      kiroDataError: 'Formato de datos anormal devuelto por Kiro',
      kiroUnknownError: 'Error desconocido de Kiro, reinicie el software',
      kiroProUnlimitedTip:
        'Kiro latest policy changed to Pro and Pro trial users can call models unlimited',
    },
    login: {
    ...
    systemControl: {
      ...
      credentialStatus: 'Estado del Credential',
      credentialApplied: 'Aplicado',
      credentialNotApplied: 'No aplicado',
      applyCredential: 'Aplicar Credential',
      restoreCredential: 'Restaurar Credential',
    ...
    common: {
      ...
      kiroRunning: 'Kiro en ejecución',
      kiroRunningMessage:
        'Se detectó que Kiro está en ejecución, ¡guarde el proyecto que no ha sido modificado antes de continuar!',
      closingKiro: 'Cerrando Kiro...',
      forgotPassword: '¿Olvidó su contraseña?',
    ...
    historyAccount: {
      ...
      credentialFailed: 'Inyección fallida, intente inyectar manualmente',
